...
<div class="graphs">
	<h3 class="blank1">Đơn đặt hàng bị hủy</h3>
<div>
<p class="btn-control">
...
<p class="total-row"><strong>Tổng cộng</strong> : <?echo $total_rows?> đơn hàng bị hủy.</p>
</div>
	<div class="xs tabls">
	  ...
	  <tbody>
		...
		<tr <?if($i%2==0) echo "class='active'"?>>
		  ...
		  <td><a href="<?echo admin_url("orders/order_return/").$order->id?>"><i  style="color:#337ab7" class="fas fa-reply"></i> Khôi phục</a></td>
		 
		</tr>
		<tr <?if($i%2==0) echo "class='active'"?>>
			<td><?echo $i?></td>
			<td><span style="font-weight:bold">Gía trị:</span> <span style="color:red"><?echo number_format($order->total)?> đ<span></td>
